 ...
 *  STATIC VARIABLES
 **********************/
static LV_ATTRIBUTE_LARGE_RAM_ARRAY lv_color_t lcdbuf_gui[MY_DISP_HOR_RES];
static LV_ATTRIBUTE_LARGE_RAM_ARRAY lv_color_t lcdbuf_show[MY_DISP_HOR_RES];
/**********************
 *      MACROS
 **********************/
...
{
    lcdbuf_gui[y * MY_DISP_HOR_RES + x] = color;
}
void gui2show(void)
{
